...
namespace Poseidon.API.Test.Integration
{
    public class RuleNameControllerTests
    {
        ...
        public async Task TestGetAllRuleNamePopulated()
        {
            ...
            ActionResult<IEnumerable<RuleNameViewModel>> result;
            ...
            var objectResult = Assert.IsAssignableFrom<IEnumerable<RuleNameViewModel>>(actionResult.Value);
        ...
        public async Task TestGetIdBad()
        {
            ...
            ActionResult<RuleNameViewModel> result;
        ...
        public async Task TestGetIdValid()
        {
            ...
            // Assert
            var actionResult = Assert.IsAssignableFrom<OkObjectResult>(result.Result);
            var objectResult = Assert.IsAssignableFrom<RuleNameViewModel>(actionResult.Value);
